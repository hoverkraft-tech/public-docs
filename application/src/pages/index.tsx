	...
	const features = [
		{
			...
			title: "Open Source",
			description:
				"Every project is open source and community-driven. Transparency and collaboration at the core.",
		},
		{
			icon: "⚡",
			title: "Developer First",
			description:
				"Built by developers, for developers. Clean APIs, comprehensive docs, and great DX.",
		},
		{
			icon: "🤝",
			title: "Community",
			description:
				"Join our growing community of contributors building the future of open-source.",
		},
		{
			icon: "🚀",
			title: "Innovation",
			description:
				"Pushing the boundaries with cutting-edge technologies and forward-thinking solutions.",
		},
	];
		...
		<section style={{ padding: "4rem 0" }}>
			<div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 1rem" }}>
				<div style={{ textAlign: "center", marginBottom: "3rem" }}>
					...
					>
						Discover a curated collection of tools, libraries, and frameworks
...
export { HeroSection, ProjectsSection, ValuePropsSection };
