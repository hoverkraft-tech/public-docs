...
Welcome to the Hoverkraft scaffolding guides. This section provides step-by-step tutorials for creating new repositories using Hoverkraft's reusable workflows and best practices.

## What is Repository Scaffolding?

Repository scaffolding is the process of setting up a new repository with the correct structure, workflows, and configurations to follow Hoverkraft best practices from the start. Instead of starting from scratch, you can leverage our reusable components to:
...
1. **Choose your project type**: Select the scaffolding guide that matches what you want to build
...
## Why Use Hoverkraft Scaffolding?
...
Have a new scaffolding template to share? We welcome contributions!
...
Ready to scaffold your first repository? Start with the **[Docker Base Images Repository](./docker-base-images/)** guide →
