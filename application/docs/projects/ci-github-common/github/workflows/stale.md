...
<div align="center">
  <img src="/ci-github-common/assets/github/logo.svg" width="60px" align="center" alt="Mark stale issues and pull requests" />
</div>
...
jobs:
  stale:
    uses: hoverkraft-tech/ci-github-common/.github/workflows/stale.yml@a55670b58d3e064526201acde6c720ede638420c # 0.31.0
    permissions: {}
    with:
