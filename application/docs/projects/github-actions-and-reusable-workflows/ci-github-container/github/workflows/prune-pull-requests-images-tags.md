...
<div align="center">
  <img src="/ci-github-container/assets/github/logo.svg" width="60px" align="center" alt="Prune pull requests images tags" />
</div>
...
jobs:
  prune-pull-requests-images-tags:
    uses: hoverkraft-tech/ci-github-container/.github/workflows/prune-pull-requests-images-tags.yml@c9088e8447c5a8be45157e17701023fc50ccb1c0 # 0.37.2
    permissions:
      contents: read
      packages: write
      pull-requests: read
