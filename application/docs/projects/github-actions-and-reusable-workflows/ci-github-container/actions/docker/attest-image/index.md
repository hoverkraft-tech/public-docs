...
<div align="center">
  <img src="/ci-github-container/assets/github/logo.svg" width="60px" align="center" alt="Docker - Attest image" />
</div>
...
See [sign-images](../sign-images/index.md) for registry-native image signing.
...
1. Build image
1. Push image
1. Resolve immutable digest
1. **Sign image** with `sign-images` (cosign)
1. **Attest provenance** with `attest-image` (this action)
