---
title: Prune Pull Requests Image Tags
...
<div align="center">
  <img src="/ci-github-container/assets/github/logo.svg" width="60px" align="center" alt="Prune pull requests image tags from GitHub Packages" />
</div>
...
```yaml
- uses: hoverkraft-tech/ci-github-container/actions/docker/prune-pull-requests-image-tags@f8255a6a37eb141fa331527f5aed9b9e1d598c77 # 0.38.0
  with:
    # Image name
    image: ""
