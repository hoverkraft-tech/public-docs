...
<div align="center">
  <img src="/ci-github-common/assets/github/logo.svg" width="60px" align="center" alt="Parse CI Reports" />
</div>
...
```yaml
- uses: hoverkraft-tech/ci-github-common/actions/parse-ci-reports@3a27d31e9ccefbe9609cc9165017ed100ff34a22 # 0.38.0
  with:
...
1. Implement `canParse()`, `parse()`, and `getPriority()` methods
1. Add the parser to `ParserFactory`
