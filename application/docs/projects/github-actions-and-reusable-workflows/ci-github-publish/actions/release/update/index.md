...
Prefer [release/create](../create/index.md) when you are creating the release for the first time and already have the final assets ready. Use this action for later body, asset, or publish changes on an existing release.
