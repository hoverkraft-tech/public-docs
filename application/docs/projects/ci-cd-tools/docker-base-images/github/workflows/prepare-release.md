...
<div align="center">
  <img src="/docker-base-images/assets/github/logo.svg" width="60px" align="center" alt="Prepare Release" />
</div>
...
jobs:
  prepare-release:
    uses: hoverkraft-tech/docker-base-images/.github/workflows/prepare-release.yml@30a8796b459d64436a0fba25ab1667a244e218ed # 0.5.2
    permissions:
      contents: read
      pull-requests: write
    secrets:
