...

  {
    ...
    projects: [

      {
        ...
        meta: 'Makefile • ⭐ 1 • Updated May 18, 2026',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'TypeScript • ⭐ 0 • Updated May 18, 2026',
...
export const projectSnapshot = {
  ...
  technologiesSummary: 'including Makefile, TypeScript, Astro, JavaScript, Go, and more.'
