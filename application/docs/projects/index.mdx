...

  {
    ...
    projects: [

      {
        ...
        meta: 'TypeScript • ⭐ 5 • Updated Apr 6, 2026',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'Astro • ⭐ 2 • Updated Apr 4, 2026',
...
export const projectSnapshot = {
  ...
  technologiesSummary: 'including TypeScript, Astro, Go Template, Makefile, JavaScript, and more.'
