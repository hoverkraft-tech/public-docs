...

  {
    ...
    projects: [

      {
        ...
        meta: 'Astro • ⭐ 2 • Updated Dec 24, 2025',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'JavaScript • ⭐ 1 • Updated Dec 24, 2025',
...
export const projectSnapshot = {
  ...
  technologiesSummary: 'including Astro, JavaScript, TypeScript, Makefile, Smarty, and more.'
