...

  {
    ...
    projects: [
...

      {
        ...
        meta: 'TypeScript • ⭐ 210 • Updated Jun 3, 2026',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'JavaScript • ⭐ 1 • Updated Jun 3, 2026',
...
export const projectSnapshot = {
  ...
  technologiesSummary: 'including JavaScript, Makefile, TypeScript, Go Template, Vue, and more.'
