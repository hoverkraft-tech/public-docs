...

  {
    ...
    projects: [

      {
        ...
        meta: 'Go Template • ⭐ 5 • Updated Aug 4, 2026',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'Astro • ⭐ 2 • Updated Aug 4, 2026',
...
export const projectSnapshot = {
  ...
  technologiesSummary: 'including Go Template, Astro, TypeScript, Makefile, JavaScript, and more.'
