...

  {
    ...
    projects: [

      {
        ...
        meta: 'JavaScript • ⭐ 5 • Updated Sep 18, 2026',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'Astro • ⭐ 2 • Updated Sep 18, 2026',
...
export const projectSnapshot = {
  ...
  technologiesSummary: 'including Astro, JavaScript, TypeScript, Makefile, Go Template, and more.'
