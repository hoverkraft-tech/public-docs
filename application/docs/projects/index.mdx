...

  {
    ...
    projects: [

      {
        ...
        meta: 'TypeScript • ⭐ 5 • Updated Jun 12, 2026',
...

      {
        ...
        meta: 'Go Template • ⭐ 5 • Updated Jun 12, 2026',
...

      {
        ...
        meta: 'JavaScript • ⭐ 4 • Updated Jun 12, 2026',
...

      {
        ...
        meta: 'JavaScript • ⭐ 5 • Updated Jun 10, 2026',
...

      {
        ...
        meta: 'Makefile • ⭐ 1 • Updated Jun 6, 2026',
...

      {
        ...
        meta: 'TypeScript • ⭐ 210 • Updated Jun 4, 2026',
...

      {
        ...
        meta: 'TypeScript • ⭐ 2 • Updated May 27, 2026',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'JavaScript • ⭐ 1 • Updated Jun 12, 2026',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'HCL • ⭐ 1 • Updated Jun 12, 2026',

        description: 'Boilerplate for bootstrapping an AWS environment using hoverkraft-tech',
...

      {
        ...
        meta: 'HCL • ⭐ 3 • Updated Apr 28, 2026',
...

  {
    ...
    projects: [

      {
        ...
        title: 'helm-chart-codespace-like',

        titleHref: 'https://github.com/hoverkraft-tech/helm-chart-codespace-like',

        meta: 'Go Template • ⭐ 0 • Updated Jun 7, 2026',
        ...
        actions: [

          {
            ...
            href: 'https://github.com/hoverkraft-tech/helm-chart-codespace-like'
...

  {
    ...
    projects: [

      {
        ...
        meta: 'Astro • ⭐ 2 • Updated Jun 12, 2026',
...

      {
        ...
        titleHref: 'https://github.com/hoverkraft-tech/slidev-theme',

        meta: 'Vue • ⭐ 0 • Updated Jun 10, 2026',

        description: 'Hoverkraft theme for Slidev',
        ...
        actions: [

          {
            ...
            href: 'https://github.com/hoverkraft-tech/slidev-theme'
...

          {
            ...
            href: 'https://hoverkraft-tech.github.io/slidev-theme/'
...

      {
        ...
        title: 'argocd-template-app-of-apps',

        titleHref: 'https://github.com/hoverkraft-tech/argocd-template-app-of-apps',

        meta: 'Go Template • ⭐ 0 • Updated Jun 8, 2026',
        ...
        actions: [

          {
            ...
            href: 'https://github.com/hoverkraft-tech/argocd-template-app-of-apps'
...

      {
        ...
        meta: 'TypeScript • ⭐ 0 • Updated Jun 2, 2026',
...

      {
        ...
        titleHref: 'https://github.com/hoverkraft-tech/next-ip',

        meta: 'Go • ⭐ 0 • Updated May 18, 2026',

        description: 'Small binary that allow to get next IPs in a given range',
        ...
        actions: [

          {
            ...
            href: 'https://github.com/hoverkraft-tech/next-ip'
...
export const projectSnapshot = {
  ...
  technologiesSummary: 'including TypeScript, Astro, JavaScript, HCL, Go Template, and more.'
