...

  {
    ...
    projects: [

      {
        ...
        meta: 'JavaScript • ⭐ 4 • Updated Feb 13, 2026',
...

      {
        ...
        meta: 'Makefile • ⭐ 1 • Updated Feb 13, 2026',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'JavaScript • ⭐ 1 • Updated Feb 13, 2026',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'Astro • ⭐ 2 • Updated Feb 11, 2026',
...
export const projectSnapshot = {
  ...
  technologiesSummary: 'including JavaScript, Makefile, Astro, TypeScript, Go Template, and more.'
