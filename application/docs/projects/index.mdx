...

  {
    ...
    projects: [

      {
        ...
        meta: 'JavaScript • ⭐ 2 • Updated Dec 1, 2025',
...

      {
        ...
        meta: 'Makefile • ⭐ 1 • Updated Dec 1, 2025',
...
export const projectSnapshot = {
  ...
  technologiesSummary: 'including JavaScript, Makefile, Astro, Shell, TypeScript, and more.'
