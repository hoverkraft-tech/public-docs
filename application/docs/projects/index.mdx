...

  {
    ...
    projects: [

      {
        ...
        meta: 'JavaScript • ⭐ 4 • Updated Jun 6, 2026',
...

      {
        ...
        meta: 'Makefile • ⭐ 1 • Updated Jun 5, 2026',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'JavaScript • ⭐ 1 • Updated Jun 5, 2026',
...

  {
    ...
    projects: [

      {
        ...
        meta: 'Go Template • ⭐ 0 • Updated Jun 4, 2026',
...

  {
    ...
    projects: [
...

      {
        ...
        meta: 'Astro • ⭐ 2 • Updated Jun 5, 2026',
...
export const projectSnapshot = {
  ...
  technologiesSummary: 'including JavaScript, Vue, Astro, Makefile, TypeScript, and more.'
