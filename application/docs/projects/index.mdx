...

  {
    ...
    projects: [

      {
        ...
        meta: 'Go Template • ⭐ 4 • Updated Mar 5, 2026',
...

      {
        ...
        meta: 'TypeScript • ⭐ 205 • Updated Mar 5, 2026',
...
export const projectSnapshot = {
  ...
  technologiesSummary: 'including Go Template, TypeScript, Makefile, JavaScript, Astro, and more.'
