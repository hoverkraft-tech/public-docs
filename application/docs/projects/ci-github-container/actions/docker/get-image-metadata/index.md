...
source_branch: main
source_run_id: 19837261493
last_synced: 2025-12-01T21:04:52.767Z
---
...
<div align="center">
  <img src="/ci-github-container/assets/github/logo.svg" width="60px" align="center" alt="Get image metadata" />
</div>
...
```yaml
- uses: hoverkraft-tech/ci-github-container/actions/docker/get-image-metadata@0d92511a38c93e30ae0f8b82346116946987a9ca # 0.30.0
  with:
    ...
    # Repository name. Example: `my-org/my-repo`. See [Docker get-image-name action](../get-image-name/index.md)
    # Default: `${{ github.repository }}`
    repository: ${{ github.repository }}

    # Additional image name. Example: `application`. See [Docker get-image-name action](../get-image-name/index.md)
    image: ""
